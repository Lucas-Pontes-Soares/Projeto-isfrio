...
?>
    ...
    <body>
    <div class="fundo">
        <nav class="navbar fixed-top" id="teste">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="imagens/sorveteFamoso.png" height="650px" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="imagens/sorveteFamoso2.png" height="650px" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="imagens/sorveteFamoso3.png" height="650px" alt="Third slide">
                </div>
            </div>
